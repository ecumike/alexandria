...
class ArtifactForm(ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'abstract': forms.Textarea(attrs={'rows':3, 'class':'bo-common-autotextarea'}),
			'description': forms.Textarea(attrs={'rows':3, 'class':'bo-common-autotextarea'}),
			'hypothesis': forms.Textarea(attrs={'rows':3, 'class':'bo-common-autotextarea'}),
