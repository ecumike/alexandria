...
TEMPLATES = [
	{
		...
		'OPTIONS': {
			'context_processors': [
				'omnia.context_processors.app_settings',
...
WSGI_APPLICATION = 'omnia.wsgi.application'
...
DATABASES = {
	'default': {
		...
		'NAME': os.getenv('DJANGO_DB_NAME', 'omnia'),
...
STATIC_URL = os.getenv('DJANGO_STATIC_URL', '/static-omnia/')
